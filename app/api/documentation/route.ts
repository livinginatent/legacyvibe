...
This repository contains **${
  ...
  } major features** organized across **${totalFiles} critical files**.
...
The system is organized into ${
    blueprint.nodes.length
  } interconnected features. Below is a breakdown of the major components:
...
This documentation is auto-generated from the codebase using Cadracode's Blueprint Orchestrator.

To regenerate:
1. Re-scan the repository in Cadracode
...
_Generated by [Cadracode](https://cadracode.com) - AI-Powered Codebase Understanding_`;
}
